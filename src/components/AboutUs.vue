    ...
    <div class="grid grid-cols-2 py-16">
      ...
      <div class="col-span-1 max-w-lg">
        ...
        <p class="text-base text-gray-50 leading-relaxed">
          ...
          food online a breeze. With a user-friendly interface, seamless navigation, and a vast
          selection of restaurants and cuisines to choose from, you'll find exactly what you're
          craving in no time.
        </p>
      </div>
    </div>
